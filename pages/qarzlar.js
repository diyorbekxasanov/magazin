...
const Qarzlar = () => {
  ...
  const state2 = useSelector((state) => state.qarz.odamData);
  ...
  const delet = (i) => {
    const action = { type: "DELETE_TASK_2", payload: i };
    dispatch(action);
  };
  const edit = (i) => {
    setedited(i);
  ...
  const activeBut = (i, e) => {
    const action = { type: "ACTIVE_TASK_2", payload: i };
    dispatch(action);
    setfilterstate(e);
  };
    ...
    <div>
      ...
      <QarzIndex>
        <div className="pul container">
          ...
          <div className="box">
            <h2>umumiy berildi:</h2>
            <h3>{uberildi}</h3>
          </div>
          <div className="box">
            <h2>umumiy qoldi:</h2>
            <h3>{Number(uqarz) - Number(uberildi)}</h3>
          </div>
        </div>
        <div>
          <Modal isOpen={open}>
